use crate::{geom::line2::Line2, math::structs::{Field, Zero, One, Inf}};
...
impl LichaoFuncType for Line2<i64>{
	type F=i64;
	fn eval(&self, x:Self::F)->Self::F {self.caly(x)}
	fn id()->Self{Self{a:Self::F::zero(),b:Self::F::one(),c:Self::F::inf()}}
}
